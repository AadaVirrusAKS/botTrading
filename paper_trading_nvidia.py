...
# -----------------------------
# PAPER TRADING SYSTEM FOR NVIDIA (NVDA)
# -----------------------------

class PaperTradingNVDA:
    def __init__(self, initial_capital=10000):
        self.initial_capital = initial_capital
        self.current_capital = initial_capital
        self.position = None  # Current open position
        self.trades_file = 'nvda_paper_trades.xlsx'
        self.positions_file = 'nvda_current_position.xlsx'
    ...
    def run_daily_check(self):
        ...
        print("=" * 60)
        print(f"NVIDIA (NVDA) PAPER TRADING - Daily Check")
        print(f"Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        print("=" * 60)
        
        # Download recent NVDA data
...
if __name__ == "__main__":
    trader = PaperTradingNVDA(initial_capital=10000)
