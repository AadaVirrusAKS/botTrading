...
2. Import in the appropriate `routes/` blueprint
...
Edit `get_top_movers()` function in the routes module:
```python
watchlist = [
...
3. Modify data fetching functions in `services/market_data.py`
