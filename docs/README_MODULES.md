...
│   └── web_app.py              # Flask + SocketIO app (194 lines)
│
...
|----------|------|---------|
| `active_subscriptions` | `dict` | WebSocket quote streaming (app/web_app.py) |
