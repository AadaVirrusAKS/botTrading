...
| Feature | Desktop (trading_ui_app.py) | Web App (web_app.py) |
|---------|----------------------------|---------------------|
...
```python
scanner_cache_timeout = 300  # 5 minutes (in web_app.py line 104)
```

### Quote Cache Timeout
```python
cache_timeout = 15  # 15 seconds (in web_app.py line 101)
```
...
### Modified
- `web_app.py` - Added 4 new scanners, custom analyzer, improved caching
...
**Lines of Code**: ~1,300 (web_app.py)
